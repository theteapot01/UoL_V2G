...
def _build_tls() -> c104.TransportSecurity:
    ...
    # Mirror the client cipher list so both sides agree on ECDHE_ECDSA suites.
    # Without this, the server's default list may not advertise ECDHE_ECDSA
    # on arm32 Pi builds, causing cipher-suite mismatch with ECDSA certs.
